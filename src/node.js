...
// // rectangular nodes are good... but are they GREAT?!
// // no one knows
//
...
// //     .data(nodes)
// //     .join("g")
// //     .attr("transform", (d) => `translate(${nodeScale(d.influence) * -1})`)
// //     // .attr("x", (d) => nodeScale(d.influence) * -1)
// //     // .attr("y", (d) => nodeScale(d.influence) * -1)
// //     .append("image")
// //     .attr("xlink:href", (d) => `images/${d.image}`)
// //     .attr("clip-path", (d) => `url(#${d.id})`)
// //     .attr("width",(d) => nodeScale(d.influence) * 2)
// //     .attr("height",(d) => nodeScale(d.influence) * 2)
// // // .attr("x", nodeScale(d.influence) * -1)
// // // .attr("y", nodeScale(d.influence) * -1)
// //
// //
...
// //     .attr("xlink:href", (d) => `images/${d.image}`)
// //     .attr("clip-path", (d) => `url(#${d.id})`)
// //     .attr("width",(d) => nodeScale(d.influence) * 3)
// //     .attr("height",(d) => nodeScale(d.influence) * 3)
// //     // .attr("x", nodeScale(d.influence) * -1)
// //     // .attr("y", nodeScale(d.influence) * -1)
//
